...
module.exports = {
	...
	URLRSS2: (str1, class1, text, social) => {
		...
		if (text == "soundcloud"){
			...
			out += `<a class="${social} div_share fb-like undone" id="div_share" onclick="$(this).removeClass('undone');$(this).addClass('done');"><div id="${social}"><i class="fab fa-${social}"></i></div><div class="label-social">${text}</div></a>
